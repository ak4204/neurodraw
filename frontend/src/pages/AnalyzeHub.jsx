    ...
    <div className="main-content flex-col" style={{ alignItems: 'center', paddingTop: 60 }}>
      <div style={{ textAlign: 'center', marginBottom: 48 }}>
        ...
        <p className="page-greeting" style={{ fontSize: '1.1rem' }}>
          Select the appropriate workflow for your research data.
        </p>
      </div>
      ...
      <div className="grid-3" style={{ width: '100%', maxWidth: 1100 }}>
        ...
        {/* Fusion Analysis */}
        <Link to="/analyze/fusion" className="card" style={{ display: 'flex', flexDirection: 'column', textDecoration: 'none', transition: 'all var(--t)' }}>
          ...
          <h3 style={{ fontSize: '1.25rem', color: 'var(--c-ink)', marginBottom: 12 }}>Fusion Analysis</h3>
          <p style={{ color: 'var(--c-ink-muted)', fontSize: '0.95rem', flex: 1, marginBottom: 24 }}>
            Combine kinematic pen-signal analysis and image-based deep learning on the same handwriting sample for a unified, cross-modal prediction.
          </p>
